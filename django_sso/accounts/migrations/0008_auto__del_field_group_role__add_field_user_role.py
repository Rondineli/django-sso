...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'accounts_group', 'role')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Group.role'
        raise RuntimeError("Cannot reverse this migration. 'Group.role' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Group.role'
        db.add_column(u'accounts_group', 'role',
